...
#undef GGWAVE_PSTR
    ...
    //
    bool computeFFTR(const float * src, float * dst, int Ni);
    ...
    //
    static int computeFFTR(const float * src, float * dst, int Ni, int * wi, float * wf);
    ...
    //
    static int filter(ggwave_Filter filter, float * waveform, int Ni, float p0, float p1, float * w);
