/**
 * This file implements the i2c from MSP430 to a slave.
 */

#include "i2c.h"

// Definitions — this is where memory is actually reserved
...
I2C_Mode I2C_Master_Read(uint8_t dev_addr, uint8_t *dest, uint8_t count)
{
    ...
    CopyArray(ReceiveBuffer, dest, count); // retrieve data from ReceiveBuffer
